...
def main():
    ...
    button_one_player = menu_functions.Button(window, mouse, width = 100, heigth = 50, pos = (100, 600), text = "Egy játékos", fontsize = 25)
    button_two_player = menu_functions.Button(window, mouse, width = 100, heigth = 50, pos = (300, 600), text = "Két játékos", fontsize = 25, color_click = (153,153,0), color_unclicked = (153,153,0))
    ...
    while not quit:
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and button_one_player.on_button:
            return True
